...
2. 네 가지 분류
   ...
   - 에측 기반 스케일 : 과거의 기록의 패턴을 기반으로 수요량을 예측해서 인스턴스 숫자를 증감
...
4. 스케줄 기반 스케일링
   - 에측 가능한 시점의 변동사항에 대비해서 인스턴스 숫자를 조절하는 방식 (예) 매주 수요일마다 주간 이벤트가 있는 게임의 경우 / 매일 새벽 특정 시간에 하루동안 모인 데이터를 분석)
   - 적용 방식
