...
6. 잘 활용하는 방법 : 언제나 떨어질 수 있으므로, 인스턴스를 자동으로 Provision 할 수 있는 방법 / 인스턴스를 가용영역 별로 분산할 수 있는 방법 / 인스턴스 클러스터에 트래픽을 분산할 수 있는 방법 / 인스턴스 각자 상태를 저장하지 않고, 언제나 삭제되고 추가되도 무방할 수 있는 방법 필요
<div align="center">
